                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;">
                                                <a class="btn btn-warning" id="detail_pesanan" href="#" title="Quick view" data-toggle="modal" data-target="#exampleModal2" onclick="detail_pembelian(<?= $k['id_user'] ?>, <?= $k['id'] ?>, <?= $k['total'] ?>)"><i class="fa fa-eye"></i></a>
                                                <a class="btn btn-primary" href="/home/surat_pembelian/<?= $k['id'] ?>"><i class="fa fa-print"></i></a> </a>
                                                <form action="/penjualan/<?= $k['id'] ?>" method="POST" class="d-inline">
                                                    <?= csrf_field() ?>
