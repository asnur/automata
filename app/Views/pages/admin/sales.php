            ...
            <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <div class="float-right">
                        <a href="/admin/tambah_sales" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data</a>
                    </div>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $p['no_hp'] ?></td>
                                            <td>
                                                <form action="/sales/<?= $p['id'] ?>" method="POST" class="d-inline">
                                                    <?= csrf_field(); ?>
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                                </form>
                                                <a href="/admin/edit_sales/<?= $p['id'] ?>" class="btn btn-warning"><i class="fa fa-edit"></i></i></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
