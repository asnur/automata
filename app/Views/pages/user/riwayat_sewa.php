        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center" style="vertical-align: middle;">
                        <a class="btn btn-warning rounded-pill" id="detail_pesanan" href="#" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="detail_penyewaan(<?= $_SESSION['user'][0]['id'] ?>, <?= $k['id'] ?>, <?= $k['total'] ?>)"> Detail</a>
                        <a class="btn btn-primary rounded-pill" href="/home/surat_penyewaan/<?= $k['id'] ?>"> Cetak</a>
                    </td>
                </tr>
            <?php
            }
