...
namespace CodeIgniterCartSewa {
    ...
    class Cartsewa
    {
        ...
        public function __construct()
        {
            ...
            $this->cartContents = $this->session->get('cart_contents_sewa');
        ...
        protected function _insert($items = [])
        {
            ...
            $old_quantity = isset($this->cartContents[$rowid]['quantity']) ? (int)$this->cartContents[$rowid]['quantity'] : 0;

            // Re-create the entry, just to make sure our index contains only the data from this submission
            $items['rowid'] = $rowid;
            $items['quantity'] += $old_quantity;
        ...
        protected function saveCart(): bool
        {
            ...
            foreach ($this->cartContents as $key => $val) {
                ...
                if (!is_array($val) || !isset($val['price'], $val['quantity'])) {
                    continue;
                }
            ...
            if (count($this->cartContents) <= 2) {
                $this->session->remove('cart_contents_sewa');
            ...
            $this->session->set('cart_contents_sewa', $this->cartContents);
